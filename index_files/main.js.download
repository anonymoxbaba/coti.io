    ...
    (s.m = r),
        ...
        (() => {
            ...
            class o {
                ...
                injectMetadata(e, t) {
                    e && ((e.zendesk = { [this.name]: { id: this.id, features: this.features, bootstrap: this.bootstrap } }), Object && Object.freeze && this.deepFreeze(e.zendesk), (e.zEQueue = t));
                }
                deepFreeze(e) {
                    return (
                        Object.freeze(e),
                    ...
                    new Promise((e) => {
                        f
                            ...
                            : s
                                  ...
                                  .then(s.bind(s, 858))
                                  .then((t) => {
                                      const { BrowserClient: r, makeFetchTransport: n, defaultStackParser: s, Hub: o, Integrations: i } = t,
                                          a = new r({ ...w, integrations: [new i.InboundFilters(), new i.FunctionToString(), new i.HttpContext()], transport: n, stackParser: s });
                                      (f = new o(a)), e(f);
                                  });
                    });
            function b(t) {
